...
# Calcula la función de valor óptima de un MDP mediante iteración de valores: actualiza repetidamente 
# V(s) usando el retorno esperado hasta converger, determinando así la utilidad óptima de cada estado.
